...
image: "/images/blog/strategie-tests.svg"
draft: false
order: 6
---
...
Cette suite a pourtant une limite que j'ai mesurée depuis : un test vérifie du code, jamais la documentation qui le décrit. Sur un projet plus récent, j'ai vu des règles métier en prose décrire des colonnes qui n'existaient plus, sans qu'aucun des tests ne bronche. J'explique dans [Pourquoi j'encadre mon agent de code](/blog/claude-code-01-pourquoi-encadrer-un-agent/) comment un contrôle automatique rattrape cette dérive, et pourquoi un contrôle qui n'a jamais échoué sur le défaut qu'il prétend attraper n'est pas un contrôle.
