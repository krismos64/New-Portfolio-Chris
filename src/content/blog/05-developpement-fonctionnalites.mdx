...
image: "/images/blog/developpement-features.svg"
draft: false
order: 5
---
...
![Dashboard Manager SmartPlanning : statistiques d'équipe, congés en attente et absences du jour](/images/blog/capture1.webp)
*Dashboard Manager : vue d'ensemble de l'équipe avec KPIs en temps réel et demandes de congés*

![Liste des collaborateurs SmartPlanning : tableau avec export PDF/CSV et gestion des employés](/images/blog/capture2.webp)
*Gestion des collaborateurs : tableau paginé avec export, filtres et accès rapide aux fiches*
...
![Vue planning mensuelle SmartPlanning : créneaux par employé avec filtres statut, type et équipe](/images/blog/capture3.webp)
*Vue planning mensuelle : créneaux colorés par type, filtres multi-critères et compteur d'heures*

![Vue planning hebdomadaire SmartPlanning : grille horaire avec créneaux drag & drop et heures semaine](/images/blog/capture6.webp)
*Vue planning hebdomadaire : grille horaire par employé avec récapitulatif des heures planifiées*
...
![Interface de gestion des congés SmartPlanning : liste filtrée avec statuts approuvé, annulé et en attente](/images/blog/capture4.webp)
*Gestion des congés Manager : filtres multi-critères, badges de statut et actions rapides par demande*
...
La conformité RGPD n'est pas un patch ajouté après coup.

![Profil employé SmartPlanning : informations personnelles, professionnelles et actions RGPD](/images/blog/capture5.webp)
*Fiche profil employé : informations personnelles, statut du compte et actions RGPD (export, suppression)* Droit d'accès avec export JSON depuis le profil, droit à l'effacement avec suppression en cascade, consentement cookies granulaire (validité 12 mois), minimisation des données collectées. L'analytics est assurée par **Umami auto-hébergé** : aucune donnée transmise à des tiers.
