...
![Dashboard Manager SmartPlanning — statistiques d'équipe, congés en attente et absences du jour](/images/blog/capture1.png)
*Dashboard Manager : vue d'ensemble de l'équipe avec KPIs en temps réel et demandes de congés*

![Liste des collaborateurs SmartPlanning — tableau avec export PDF/CSV et gestion des employés](/images/blog/capture2.png)
...
![Vue planning mensuelle SmartPlanning — créneaux par employé avec filtres statut, type et équipe](/images/blog/capture3.png)
*Vue planning mensuelle : créneaux colorés par type, filtres multi-critères et compteur d'heures*

![Vue planning hebdomadaire SmartPlanning — grille horaire avec créneaux drag & drop et heures semaine](/images/blog/capture6.png)
...
![Interface de gestion des congés SmartPlanning — liste filtrée avec statuts approuvé, annulé et en attente](/images/blog/capture4.png)
...
![Profil employé SmartPlanning — informations personnelles, professionnelles et actions RGPD](/images/blog/capture5.png)
