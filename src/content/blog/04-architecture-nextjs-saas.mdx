...
![Architecture en couches de SmartPlanning : Présentation, Métier, Accès aux données, Infrastructure](/images/blog/architecture-en-couche.webp)
*Architecture multicouche : chaque couche a une responsabilité unique et des dépendances unidirectionnelles*
