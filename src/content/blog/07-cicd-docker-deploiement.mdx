...
![Workflow Git professionnel — branche feature, commits atomiques, PR, CI auto, merge main](/images/blog/workflow.png)
...
![Pipeline GitHub Actions — Lint & Type Check, Unit Tests, Build Application, E2E Tests en succès](/images/blog/pipeline.png)
...
![Schéma déploiement automatisé — Push main, Tests CI, Build Docker, SSH VPS, Docker pull, Prisma migrate, Restart](/images/blog/github.png)
