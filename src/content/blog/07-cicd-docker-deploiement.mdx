...
tags:
  ["CI/CD", "Docker", "GitHub Actions", "VPS", "OVH", "DevOps", "Déploiement"]
image: "/images/blog/cicd-deploiement.svg"
draft: false
order: 7
---
...
![Workflow Git professionnel : branche feature, commits atomiques, PR, CI auto, merge main](/images/blog/workflow.webp)
...
![Pipeline GitHub Actions : Lint & Type Check, Unit Tests, Build Application, E2E Tests en succès](/images/blog/pipeline.webp)
...
![Schéma déploiement automatisé : Push main, Tests CI, Build Docker, SSH VPS, Docker pull, Prisma migrate, Restart](/images/blog/github.webp)
...
La même discipline s'applique désormais à ma façon de travailler avec un agent de code. Sur mon projet en cours, un hook de fin de session vérifie qu'aucun commit ne dort sur une branche locale, après que deux stories ont été déclarées terminées avec six commits jamais poussés. Je détaille ces garde-fous dans la série [Encadrer un agent de code sur un vrai projet](/blog/claude-code/).
