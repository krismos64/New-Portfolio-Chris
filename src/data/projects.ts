...
export const projects: Project[] = [
  {
    ...
    tech: ['Tailwind CSS', 'TypeScript', 'Animations Lottie', 'Node JS', 'React', 'MongoDB', 'Express', 'API', 'Gestion de projet', 'GitHub', 'Stack MERN', 'Intégration IA'],
    ...
    links: {
      ...
      video: 'https://www.youtube.com/watch?v=jSdnkoMc8gU&ab_channel=SmartPlanning',
  ...
  },
  {
    ...
    tech: ['Tailwind CSS', 'TypeScript', 'Confluence', 'Node JS', 'React', 'MongoDB', 'Express', 'API', 'Gestion de projet', 'GitHub', 'Stack MERN', 'Intégration IA', 'Jira', 'Figma'],
  ...
  },
  {
    ...
    tech: ['Html CSS', 'JS', 'Animations Lottie', 'Freelance', 'Services', 'Formulaire de contact'],
  ...
  },
  {
    ...
    tech: ['Symfony', 'Twig', 'Chatbot', 'PHP', 'JS', 'MySQL', 'CRUD', 'Heygen', 'IA', 'FCPX'],
  ...
  },
  {
    ...
    tech: ['Symfony', 'Twig', 'PHP', 'JS', 'MySQL', 'CRUD', 'Heygen', 'IA', 'FCPX'],
    ...
    links: {
      ...
      video: 'https://www.youtube.com/watch?v=Qjrm9HWjzbo&ab_channel=krismosDev',
  ...
  },
  {
    ...
    tech: ['React', 'JS', 'Micro-entreprise', 'Freelance', 'Services', 'Formulaire de contact'],
  ...
  },
  {
    ...
    links: {
      video: 'https://www.youtube.com/watch?v=6rEa_1e7qm8&ab_channel=krismosDev'
    }
  },
  {
    ...
    links: {
      video: 'https://www.youtube.com/watch?v=TJXDgX5yApI&ab_channel=krismosDev'
    }
  },
  {
    id: 'kaamelot',
